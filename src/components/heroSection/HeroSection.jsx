	...
	return (
		<section className="hero" id="main">
			...
			>
				...
				<motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="hero__inner">
					<div className="hero__item">
						<motion.p variants={animationText} custom={1} className="hero__animation-text">
							console.log(“hello!!!”)
						</motion.p>
						<motion.h1 variants={animationText} custom={2} className="hero__title">
							{t("main_page.hero_section_title")} <br /> {t("main_page.hero_section_title2")} - <span className="hero__title_neon">frontend developer</span>
						</motion.h1>
						<motion.p variants={animationText} custom={3} className="hero__description">
						...
						<motion.div variants={animationText} custom={4} className="hero__download-item inline-item">
							<p className="hero__download-text"> {t("main_page.hero_section_download")} CV:</p>
							<ButtonDownload secondClass="hero__download-cv" downloadUrl="../../../public/cv.pdf" image={DownloadIcon} />
						</motion.div>
					</div>
				</motion.div>
			</motion.div>
