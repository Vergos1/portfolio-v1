...
import { portfolioData } from "@/data/staticData/portfolioData.js";
  ...
  return (
    <section className="portfolio" id="portfolio">
      <div className="container container-about-me" id="about-me">
        <PageTitle
          title="page_title.portfolio_title"
          subtitle="page_title.portfolio_subtitle"
          ...
          {filteredPortfolioSlice.length > 0 ? (
            <>
              ...
              {filteredPortfolio.length > 6 && (
                ...
                >
                  {openMore
                    ? t("portfolio_card.close_more")
                    : t("portfolio_card.view_more")}
                </button>
              )}
            </>
          ) : (
